...
if id < 1{
	...
	fmt.Printf("title type:%T\n", title)
	fmt.Printf("cover type:%T\n", cover)
	fmt.Printf("tags type:%T\n", tags)
	fmt.Printf("urlname type:%T\n", urlname)
	fmt.Printf("timestr type:%T\n", timestr)
	fmt.Printf("content type:%T\n", content)
	fmt.Printf("status type:%T\n", status)
	fmt.Printf("status value:%d\n", status)
	fmt.Printf("urltype type:%T\n", urltype)
	fmt.Printf("urltype value:%d\n", urltype)
	fmt.Printf("istop type:%T\n", istop)
	fmt.Printf("istop value:%d\n", istop)
	fmt.Printf("post type:%T\n", post)
